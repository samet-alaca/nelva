...
(function ($) {
    ...
    $.fn.fileinputLocales['fr'] = {
        ...
        msgFileRequired: 'Vous devez sélectionner un fichier..',
        msgSizeTooSmall: 'Fichier "{name}" (<b>{size} KB</b>) est trop petit et doit avoir une taille supérieur à <b>{minSize} KB</b>.',
