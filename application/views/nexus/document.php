	...
	<?php if(isset($document)): ?>
		...
		<div class="row">
			<div class="col-md">
				...
				<?php if($this->session->logged && $this->session->isMember): ?>
					<div class="float-right">
						<button class="btn btn-danger" data-delete="<?php echo $slug; ?>"><i class="fa fa-trash"></i> <?php echo $this->lang->line('nexus_delete'); ?></button>
						<button class="btn btn-primary" data-edit="<?php echo $slug; ?>"><i class="fas fa-edit"></i> <?php echo $this->lang->line('nexus_edit'); ?></button>
					</div>
					<br/><br/>
				<?php endif; ?>
			</div>
